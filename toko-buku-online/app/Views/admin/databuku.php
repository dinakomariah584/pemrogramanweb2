...
<div class="col-9">
    ...
    <hr>
    <div class="my-3">
        <button data-bs-toggle="modal" data-bs-target="#tambahModal" class="btn btn-dark"><i class="bi bi-plus-lg"></i>+
            Tambah Data</button>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="formTambah" class="btn btn-primary"><i
            ...
            <div class="modal-body">
                <form action="/index.php/edit" method="POST" id="formEdit">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" name="thumbnail" id="thumbnailEdit" class="form-control"
                            placeholder="https:/example.com/image.jpg">
                    </div>
                </form>
            </div>
